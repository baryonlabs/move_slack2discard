# Slack Archive Search Plugin

> **Claude Code 플러그인**으로 Slack 아카이브를 검색하세요.
...
**첨부 파일:**
  ...
  - image.png (51200 bytes) → 로컬: ~/.claude/plugins/slack-archive-search/data/files/F001/image.png
```
...
| 이미지 안 보임 | `~/.claude/plugins/slack-archive-search/data/files/` 확인, Phase 1 재실행 |
